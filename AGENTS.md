...
Opportunities also has a passphrase-gated manual URL intake for canonical
Greenhouse/Lever/Ashby posting URLs. See `docs/job-agent.md`'s "Manual URL intake" section for
the authoritative behavior, storage, and security contract.
