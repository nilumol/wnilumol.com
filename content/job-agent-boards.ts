...
export const jobAgentBoards: JobAgentBoard[] = [
  ...
  { token: "komodohealth", label: "Komodo Health", source: "greenhouse" },
  { token: "cariboubiosciencesinc", label: "Caribou Biosciences", source: "greenhouse" },
  { token: "realchemistry", label: "Real Chemistry", source: "greenhouse" },
  { token: "brex", label: "Brex", source: "greenhouse" },
  { token: "alnylampharmaceuticals", label: "Alnylam", source: "greenhouse" },
  { token: "smithrx", label: "SmithRx", source: "greenhouse" },
  { token: "coreweave", label: "CoreWeave", source: "greenhouse" },
  ...
  { token: "AIFund", label: "AI Fund", source: "lever" },
  ...
  { token: "medscout", label: "Medscout", source: "ashby" },
];
