export interface JobScoutKeywordFamily {
...
/**
 * Title pre-filter for job-scout. A job must match the configured board's company AND at
 ...
 */
export const jobScoutKeywordFamilies: JobScoutKeywordFamily[] = [
...
export function matchJobScoutKeywordFamily(
  title: string,
  families: JobScoutKeywordFamily[] = jobScoutKeywordFamilies,
): string | null {
