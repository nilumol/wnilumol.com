...
import { jobScoutKeywordFamilyAbbreviations } from "../../content/job-scout-keywords.ts";
...
// ---------------------------------------------------------------------------
// content/job-scout-keywords.ts abbreviation mapping
// ---------------------------------------------------------------------------

test("jobScoutKeywordFamilyAbbreviations covers all five tracked families with the documented abbreviations", () => {
  assert.deepEqual(jobScoutKeywordFamilyAbbreviations, {
