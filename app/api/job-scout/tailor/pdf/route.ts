...
import { jobScoutKeywordFamilyAbbreviations } from "@/content/job-scout-keywords";
import { resumeData } from "@/content/resume-data";
import { mergeTailoredResume } from "@/scripts/job-scout/resume-tailor";
import { renderResumeHtml } from "@/scripts/job-scout/resume-template";
import { verifyTailorPassphrase } from "@/scripts/job-scout/tailor-auth";
import { parseTailorRenderRequestBody } from "@/scripts/job-scout/tailor-types";

export const runtime = "nodejs";
export const maxDuration = 60;

function pdfFilename(keywordFamily: string): string {
  const abbr = jobScoutKeywordFamilyAbbreviations[keywordFamily] ?? "GEN";
 ...
 * docs/job-scout.md for why puppeteer-core + @sparticuz/chromium (HTML/CSS printed by a real
