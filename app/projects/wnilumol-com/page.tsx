...
export const metadata: Metadata = {
  ...
  description: "Why I built wnilumol.com myself, and what building it is teaching me about how I work.",
};

export default function WnilumolComPage() {
  return (
    <main className="page-shell">
      <SiteHeader active="projects" />
      <article className="reading-page">
        <p className="eyebrow">Project · Personal essay</p>
        <h1>See One. Do One. Teach One.</h1>
        <div className="byline"><span>Winston Nilumol</span><span>7 min read</span></div>
        <blockquote>
        ...
        <section>
          ...
          <p>wnilumol.com has also become a reason to study my own work more closely.</p>
          <p>
        ...
        <section>
          <h2>Architecture is more than code</h2>
          <p>
            One of the most important things I have learned is that <strong>architecture shapes how work gets done.</strong>
          </p>
          <p>
        ...
        <section>
          <h2>An evolving practice</h2>
          <p>This site is intentionally a work in progress. I want it to evolve as I do.</p>
          <p>
          ...
          <p>
            <strong>The measure of success is not how many agents I can use or how much content they can generate.</strong> It is whether the resulting system helps me think more clearly, make better decisions, communicate more effectively, and carry an idea through to a useful result.
          </p>
        </section>

        <section>
          <h2>Why make the process visible?</h2>
          <p>
